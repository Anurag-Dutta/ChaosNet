# -*- coding: utf-8 -*-
"""
Primary_Author: Harikrishnan NB
Dtd: 22 Dec. 2020
ChaosNet decision function

Secondary_Author: Anurag Dutta
Dtd: 31 Mar. 2022
"""
...
a, b = chaosnet(traindata, trainlabel, testdata)

print("\n\nAll Metrics\n")
print(mean_squared_error(testlabel, b))
print(mean_absolute_error(testlabel, b))
print(f1_score(testlabel, b))
print(precision_score(testlabel, b))
print(accuracy_score(testlabel, b))
print(recall_score(testlabel, b))